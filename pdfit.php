...
{
    $hdu_id_in       = (int)    ($_GET['hdu_id']       ?? 0);
    $hdu_dest_in     = (string) ($_GET['hdu_dest']     ?? 'i');   // i = inline
    $hdu_pagesize_in = (string) ($_GET['hdu_pagesize'] ?? 'a4');
    pdfit($hdu_id_in, $hdu_dest_in, "Helpdesk{$hdu_id_in}.pdf", "", $hdu_pagesize_in);
}
